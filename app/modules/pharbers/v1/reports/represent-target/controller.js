...
export default Controller.extend({
    ...
    actions: {
        ...
        getShowCard(component) {
            ...
            this.store.queryMultipleObject('/api/v1/cardsRepresentTarget/0', 'report-card', this.queryConditions())
                .then((resultCardData) => {
        ...
        getResultTable(component) {
            ...
            this.store.queryObject('/api/v1/tableRepresentTarget/0', 'report-table-data', this.queryConditions())
                .then((result) => {
