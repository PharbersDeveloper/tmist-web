...
export default Controller.extend({
    actions: {
        ...
        getShowCard(component) {
            ...
            this.store.queryMultipleObject('/api/report/cards/resource', 'result-card', conditions)
                .then((resultCardData) => {
        ...
        getResultTable(component) {
            ...
            this.store.queryObject('/api/report/table/resource', 'result-table-data', conditions)
                .then((result) => {
