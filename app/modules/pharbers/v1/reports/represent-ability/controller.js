...
export default Controller.extend({
    actions: {
        ...
        getShowCard(component) {
            ...
            this.store.queryMultipleObject('/api/report/cards/represent-ability', 'result-card', conditions)
                .then((resultCardData) => {
        ...
        getResultTable(component) {
            ...
            this.store.queryObject('/api/report/table/represent-ability', 'result-table-data', conditions)
                .then((result) => {
