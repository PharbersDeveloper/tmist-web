...
export default Controller.extend({
    actions: {
        ...
        getShowCard(component) {
            ...
            this.store.queryMultipleObject('/api/v1/cardsRepresentAbility/0', 'report-card', conditions)
                .then((resultCardData) => {
        ...
        getResultTable(component) {
            ...
            this.store.queryObject('/api/v1/tableRepresentAbility/0', 'report-table-data', conditions)
                .then((result) => {
